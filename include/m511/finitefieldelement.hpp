...
Fe operator*(const Fe& a, const Fe& b){
  ...
  int64_t carry1_374 = h1_187>>26; h1_187 -= carry1_374 << 26; // carry1 < 2^32; h_187 < 2^26
  ...
  int64_t h2_374 = f11g11+carry1_374; // < 2^53
  int64_t h2_187 = f3g19+f4g18+f5g17+f6g16+f7g15+f8g14+f9g13+f10g12+f12g10+f13g9+f14g8+f15g7+f16g6+f17g5+f18g4+f19g3+carry1_374<<1; //2^52*16 +2^26*374< 2^52*2^5 +2^26*2^9< 2^58
  ...
  int64_t carry6_187 = h6_187>>26; h6_187 -= carry6_187 << 26; // carry6 < 2^32, h187 < 2^26
  int64_t h6 = f0g6+f1g5+f3g3+f5g1+f6g0+2*(f2g4+f4g2)+h6_187; // 2^56

  int64_t h7_374 = f8g19+f10g17+f11g16+f12g15+f13g14+f14g13+f15g12+f16g11+f17g10+f19g8; // 2^56
  int64_t h7_187 = f9g18+f18g9+h7_374<<1+carry5_187;// 2^57
  ...
  int64_t carry13_187 = h13_187>>26; h13_187 -= carry13_187 << 26; // carry7 < 2^32, h187 < 2^26
  int64_t h13 = f0g13+f1g12+f3g10+f4g9+f5g8+f6g7+f7g6+f8g5+f9g4+f10g3+f12g1+f13g0+2*(f2g11+f11g2)+187*h13_187;

  int64_t h14_374 = f15g19+f17g17+f19g15; // 2^54
  int64_t h14_187 = f16g18+f18g16+h14_374<<1+carry13_187;// 2^57
  ...
  int64_t carry16_187 = h16_187>>26; h16_187 -= carry16_187 << 26; // carry7 < 2^32, h187 < 2^26
  ...
  int64_t h17_187 = f18g19+f19g18+carry16_187;// 2^57
