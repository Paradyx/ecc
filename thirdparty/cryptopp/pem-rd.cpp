...
static void PEM_CipherForAlgorithm(const EncapsulatedHeader& header, const char* password, size_t length, unique_ptr<StreamTransformation>& stream);
...
static void PEM_Decrypt(BufferedTransformation& src, BufferedTransformation& dest, unique_ptr<StreamTransformation>& stream);
...
void PEM_CipherForAlgorithm(const EncapsulatedHeader& header, const char* password, size_t length, unique_ptr<StreamTransformation>& stream)
{
    ...
    if(algorithm == "AES-256-CBC")
    {
        ...
        stream = unique_ptr<StreamTransformation>(new CBC_Mode<AES>::Decryption);
    }
    ...
    else if(algorithm == "CAMELLIA-256-CBC")
    {
        ...
        stream = unique_ptr<StreamTransformation>(new CBC_Mode<Camellia>::Decryption);
    }
    ...
    else if(algorithm == "DES-EDE3-CBC")
    {
        ...
        stream = unique_ptr<StreamTransformation>(new CBC_Mode<DES_EDE3>::Decryption);
    }
    else if(algorithm == "IDEA-CBC")
    {
        ...
        stream = unique_ptr<StreamTransformation>(new CBC_Mode<IDEA>::Decryption);
    }
    else if(algorithm == "DES-CBC")
    {
        ...
        stream = unique_ptr<StreamTransformation>(new CBC_Mode<DES>::Decryption);
    }
    else
    {
...
void PEM_DecodeAndDecrypt(BufferedTransformation& src, BufferedTransformation& dest, const char* password, size_t length)
{
    ...
    unique_ptr<StreamTransformation> stream;
    PEM_CipherForAlgorithm(header, password, length, stream);

    PEM_Decrypt(temp2, dest, stream);
}

void PEM_Decrypt(BufferedTransformation& src, BufferedTransformation& dest, unique_ptr<StreamTransformation>& stream)
{
    try
    {
